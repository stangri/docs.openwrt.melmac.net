...
- 1. [The `pbr` version `1.1.6` announcement](#Thepbrversion1.1.6announcement)
- 2. [OpenWrt 23.05 release and this package](#OpenWrt23.05releaseandthispackage)
- 3. [OpenWrt 22.03 release and this package](#OpenWrt22.03releaseandthispackage)
- 4. [Description](#Description)
- 5. [Features](#Features)
  - 5.1. [Gateways/Tunnels](#GatewaysTunnels)
  - 5.2. [IPv4/IPv6/Port-Based Policies](#IPv4IPv6Port-BasedPolicies)
  - 5.3. [Domain-Based Policies](#Domain-BasedPolicies)
  - 5.4. [Physical Device Policies](#PhysicalDevicePolicies)
  - 5.5. [DSCP Tag-Based Policies](#DSCPTag-BasedPolicies)
  - 5.6. [Custom User Files](#CustomUserFiles)
  - 5.7. [Strict Enforcement](#StrictEnforcement)
  - 5.8. [Use Resolver's Set Support](#UseResolversSetSupport)
    - 5.8.1. [Use AdGuardHome ipset Support](#UseAdGuardHomeipsetSupport)
    - 5.8.2. [Use DNSMASQ ipset Support](#UseDNSMASQipsetSupport)
    - 5.8.3. [Use DNSMASQ nft sets Support](#UseDNSMASQnftsetsSupport)
  - 5.9. [Customization](#Customization)
  - 5.10. [Other Features](#OtherFeatures)
- 6. [Screenshots (luci-app-pbr)](#Screenshotsluci-app-pbr)
- 7. [How It Works](#HowItWorks)
  - 7.1. [How It Works (`nft` mode)](#HowItWorksnftmode)
  - 7.2. [How It Works (`iptables`/`ipset` mode)](#HowItWorksiptablesipsetmode)
  - 7.3. [Processing Policies](#ProcessingPolicies)
    - 7.3.1. [Processing Policies (`nft` mode)](#ProcessingPoliciesnftmode)
    - 7.3.2. [Processing Policies (`iptables`/`ipset` mode)](#ProcessingPoliciesiptablesipsetmode)
  - 7.4. [Processing DNS Policies](#ProcessingDNSPolicies)
    - 7.4.1. [Processing DNS Policies (`nft` mode)](#ProcessingDNSPoliciesnftmode)
    - 7.4.2. [Processing DNS Policies (`iptables`/`ipset` mode)](#ProcessingDNSPoliciesiptablesipsetmode)
  - 7.5. [Policies Priorities](#PoliciesPriorities)
  - 7.6. [Processing Custom User Files](#ProcessingCustomUserFiles)
    - 7.6.1. [Processing Custom User Files (`nft` mode)](#ProcessingCustomUserFilesnftmode)
    - 7.6.2. [Processing Custom User Files (`iptables`/`ipset` mode)](#ProcessingCustomUserFilesiptablesipsetmode)
- 8. [How To Install](#HowToInstall)
  - 8.1. [How To Install - OpenWrt 22.03 and newer](#HowToInstall-OpenWrt22.03andnewer)
  - 8.2. [How To Install - OpenWrt 21.02 and older](#HowToInstall-OpenWrt21.02andolder)
  - 8.3. [Requirements](#Requirements)
    - 8.3.1. [Requirements (pbr)](#Requirementspbr)
    - 8.3.2. [Requirements (pbr-iptables)](#Requirementspbr-iptables)
  - 8.4. [How to install legacy iptables/ipset packages](#Howtoinstalllegacyiptablesipsetpackages)
  - 8.5. [How to install dnsmasq-full](#Howtoinstalldnsmasq-full)
  - 8.6. [Unmet dependencies](#Unmetdependencies)
- 9. [How to use](#Howtouse)
  - 9.1. [Helpful Instructional Videos](#HelpfulInstructionalVideos)
  - 9.2. [Service Configuration Settings](#ServiceConfigurationSettings)
    - 9.2.1. [Default Settings](#DefaultSettings)
    - 9.2.2. [Policy Options](#PolicyOptions)
    - 9.2.3. [DNS Policy Options](#DNSPolicyOptions)
    - 9.2.4. [Custom User Files Include Options](#CustomUserFilesIncludeOptions)
  - 9.3. [Example Policies](#ExamplePolicies)
    - 9.3.1. [Single IP, IP Range, Local Machine, Local MAC Address](#SingleIPIPRangeLocalMachineLocalMACAddress)
    - 9.3.2. [Logmein Hamachi](#LogmeinHamachi)
    - 9.3.3. [SIP Port](#SIPPort)
    - 9.3.4. [Plex Media Server](#PlexMediaServer)
    - 9.3.5. [Emby Media Server](#EmbyMediaServer)
    - 9.3.6. [Ignore Target](#IgnoreTarget)
    - 9.3.7. [Basic OpenVPN Client Config](#BasicOpenVPNClientConfig)
    - 9.3.8. [Multiple OpenVPN Clients](#MultipleOpenVPNClients)
    - 9.3.9. [Local OpenVPN Server + OpenVPN Client (Scenario 1)](#LocalOpenVPNServerOpenVPNClientScenario1)
    - 9.3.10. [Local OpenVPN Server + OpenVPN Client (Scenario 2)](#LocalOpenVPNServerOpenVPNClientScenario2)
    - 9.3.11. [Local WireGuard Server + WireGuard Client (Scenario 1)](#LocalWireGuardServerWireGuardClientScenario1)
    - 9.3.12. [Local WireGuard Server + WireGuard Client (Scenario 2)](#LocalWireGuardServerWireGuardClientScenario2)
    - 9.3.13. [Local WireGuard Server + Another VPN Client (Scenario 1)](#LocalWireGuardServerAnotherVPNClientScenario1)
    - 9.3.14. [Local WireGuard Server + Another VPN Client (Scenario 2)](#LocalWireGuardServerAnotherVPNClientScenario2)
    - 9.3.15. [Netflix Domains](#NetflixDomains)
    - 9.3.16. [Example Custom User Files Includes](#ExampleCustomUserFilesIncludes)
- 10. [Footnotes/Known Issues](#FootnotesKnownIssues)
- 11. [FAQ](#FAQ)
  - 11.1. [A Word About Default Routing](#AWordAboutDefaultRouting)
    - 11.1.1. [OpenVPN tunnel configured via uci (/etc/config/openvpn)](#OpenVPNtunnelconfiguredviaucietcconfigopenvpn)
    - 11.1.2. [OpenVPN tunnel configured with .ovpn file](#OpenVPNtunnelconfiguredwith.ovpnfile)
    - 11.1.3. [WireGuard tunnel](#WireGuardtunnel)
  - 11.2. [A Word About Cloudflare's 1.1.1.1 App](#AWordAboutCloudflares1.1.1.1App)
  - 11.3. [A Word About DNS-over-HTTPS](#AWordAboutDNS-over-HTTPS)
  - 11.4. [A Word About HTTP/3 (QUIC)](#AWordAboutHTTP3QUIC)
  - 11.5. [A Word About IPv6 Routing](#AWordAboutIPv6Routing)
  - 11.6. [A Word About Routing Netflix/Amazon Prime/Hulu Traffic](#AWordAboutRoutingNetflixAmazonPrimeHuluTraffic)
    - 11.6.1. [Routing Netflix/Amazon Prime/Hulu Traffic via VPN Tunnel](#RoutingNetflixAmazonPrimeHuluTrafficviaVPNTunnel)
    - 11.6.2. [Routing Netflix/Amazon Prime/Hulu Traffic via WAN](#RoutingNetflixAmazonPrimeHuluTrafficviaWAN)
  - 11.7. [A Word About Interface Hotplug Script](#AWordAboutInterfaceHotplugScript)
  - 11.8. [A Word About Differences from `vpn-policy-routing`](#AWordAboutDifferencesfromvpn-policy-routing)
  - 11.9. [A Word About Migrating from `vpn-policy-routing`](#AWordAboutMigratingfromvpn-policy-routing)
- 12. [Getting Help](#GettingHelp)
  - 12.1. [First Troubleshooting Step](#FirstTroubleshootingStep)
- 13. [Thanks](#Thanks)
...
## 1. <a name='Thepbrversion1.1.6announcement'></a>The `pbr` version `1.1.6` announcement
...
## 2. <a name='OpenWrt23.05releaseandthispackage'></a>OpenWrt 23.05 release and this package
...
## 3. <a name='OpenWrt22.03releaseandthispackage'></a>OpenWrt 22.03 release and this package
...
## 4. <a name='Description'></a>Description
...
### 5.1. <a name='GatewaysTunnels'></a>Gateways/Tunnels
...
### 5.2. <a name='IPv4IPv6Port-BasedPolicies'></a>IPv4/IPv6/Port-Based Policies
...
### 5.3. <a name='Domain-BasedPolicies'></a>Domain-Based Policies
...
### 5.4. <a name='PhysicalDevicePolicies'></a>Physical Device Policies
...
### 5.5. <a name='DSCPTag-BasedPolicies'></a>DSCP Tag-Based Policies
...
### 5.6. <a name='CustomUserFiles'></a>Custom User Files
...
### 5.7. <a name='StrictEnforcement'></a>Strict Enforcement
...
### 5.8. <a name='UseResolversSetSupport'></a>Use Resolver's Set Support
...
#### 5.8.1. <a name='UseAdGuardHomeipsetSupport'></a>Use AdGuardHome ipset Support
...
#### 5.8.2. <a name='UseDNSMASQipsetSupport'></a>Use DNSMASQ ipset Support
...
#### 5.8.3. <a name='UseDNSMASQnftsetsSupport'></a>Use DNSMASQ nft sets Support
...
### 5.9. <a name='Customization'></a>Customization
...
### 5.10. <a name='OtherFeatures'></a>Other Features
...
## 6. <a name='Screenshotsluci-app-pbr'></a>Screenshots (luci-app-pbr)
...
## 7. <a name='HowItWorks'></a>How It Works

### 7.1. <a name='HowItWorksnftmode'></a>How It Works (`nft` mode)
...
### 7.2. <a name='HowItWorksiptablesipsetmode'></a>How It Works (`iptables`/`ipset` mode)
...
### 7.3. <a name='ProcessingPolicies'></a>Processing Policies
...
#### 7.3.1. <a name='ProcessingPoliciesnftmode'></a>Processing Policies (`nft` mode)
...
#### 7.3.2. <a name='ProcessingPoliciesiptablesipsetmode'></a>Processing Policies (`iptables`/`ipset` mode)
...
### 7.4. <a name='ProcessingDNSPolicies'></a>Processing DNS Policies
...
#### 7.4.1. <a name='ProcessingDNSPoliciesnftmode'></a>Processing DNS Policies (`nft` mode)
...
#### 7.4.2. <a name='ProcessingDNSPoliciesiptablesipsetmode'></a>Processing DNS Policies (`iptables`/`ipset` mode)

- Policies with the MAC-addresses, IP addresses or local device names in `src_addr` can be created as `iptables` rules or `ipset` entries.
- Policies with the netmasks `src_addr` can be created as `iptables` rules or `ipset` entries.

### 7.5. <a name='PoliciesPriorities'></a>Policies Priorities
...
### 7.6. <a name='ProcessingCustomUserFiles'></a>Processing Custom User Files
...
#### 7.6.1. <a name='ProcessingCustomUserFilesnftmode'></a>Processing Custom User Files (`nft` mode)
...
#### 7.6.2. <a name='ProcessingCustomUserFilesiptablesipsetmode'></a>Processing Custom User Files (`iptables`/`ipset` mode)
...
## 8. <a name='HowToInstall'></a>How To Install

### 8.1. <a name='HowToInstall-OpenWrt22.03andnewer'></a>How To Install - OpenWrt 22.03 and newer
...
### 8.2. <a name='HowToInstall-OpenWrt21.02andolder'></a>How To Install - OpenWrt 21.02 and older
...
#### 8.3.2. <a name='Requirementspbr-iptables'></a>Requirements (pbr-iptables)
...
### 8.4. <a name='Howtoinstalllegacyiptablesipsetpackages'></a>How to install legacy iptables/ipset packages
...
### 8.5. <a name='Howtoinstalldnsmasq-full'></a>How to install dnsmasq-full
...
### 8.6. <a name='Unmetdependencies'></a>Unmet dependencies

If you are running a development (trunk/snapshot) build of OpenWrt on your router and your build is outdated (meaning that packages of the same revision/commit hash are no longer available and when you try to satisfy the [requirements](#Requirements) you get errors), please flash either current OpenWrt release image or current development/snapshot image.

## 9. <a name='Howtouse'></a>How to use

### 9.1. <a name='HelpfulInstructionalVideos'></a>Helpful Instructional Videos
...
### 9.2. <a name='ServiceConfigurationSettings'></a>Service Configuration Settings
...
#### 9.2.1. <a name='DefaultSettings'></a>Default Settings
...
#### 9.2.2. <a name='PolicyOptions'></a>Policy Options
...
#### 9.2.3. <a name='DNSPolicyOptions'></a>DNS Policy Options
...
#### 9.2.4. <a name='CustomUserFilesIncludeOptions'></a>Custom User Files Include Options
...
### 9.3. <a name='ExamplePolicies'></a>Example Policies

#### 9.3.1. <a name='SingleIPIPRangeLocalMachineLocalMACAddress'></a>Single IP, IP Range, Local Machine, Local MAC Address
...
#### 9.3.2. <a name='LogmeinHamachi'></a>Logmein Hamachi
...
#### 9.3.3. <a name='SIPPort'></a>SIP Port
...
#### 9.3.4. <a name='PlexMediaServer'></a>Plex Media Server
...
#### 9.3.5. <a name='EmbyMediaServer'></a>Emby Media Server
...
#### 9.3.6. <a name='IgnoreTarget'></a>Ignore Target
...
#### 9.3.7. <a name='BasicOpenVPNClientConfig'></a>Basic OpenVPN Client Config
...
#### 9.3.8. <a name='MultipleOpenVPNClients'></a>Multiple OpenVPN Clients
...
#### 9.3.9. <a name='LocalOpenVPNServerOpenVPNClientScenario1'></a>Local OpenVPN Server + OpenVPN Client (Scenario 1)
...
#### 9.3.10. <a name='LocalOpenVPNServerOpenVPNClientScenario2'></a>Local OpenVPN Server + OpenVPN Client (Scenario 2)
...
#### 9.3.11. <a name='LocalWireGuardServerWireGuardClientScenario1'></a>Local WireGuard Server + WireGuard Client (Scenario 1)
...
#### 9.3.12. <a name='LocalWireGuardServerWireGuardClientScenario2'></a>Local WireGuard Server + WireGuard Client (Scenario 2)
...
#### 9.3.13. <a name='LocalWireGuardServerAnotherVPNClientScenario1'></a>Local WireGuard Server + Another VPN Client (Scenario 1)
...
#### 9.3.14. <a name='LocalWireGuardServerAnotherVPNClientScenario2'></a>Local WireGuard Server + Another VPN Client (Scenario 2)
...
#### 9.3.15. <a name='NetflixDomains'></a>Netflix Domains
...
#### 9.3.16. <a name='ExampleCustomUserFilesIncludes'></a>Example Custom User Files Includes
...
## 10. <a name='FootnotesKnownIssues'></a>Footnotes/Known Issues
...
### 11.1. <a name='AWordAboutDefaultRouting'></a>A Word About Default Routing
...
#### 11.1.1. <a name='OpenVPNtunnelconfiguredviaucietcconfigopenvpn'></a>OpenVPN tunnel configured via uci (/etc/config/openvpn)
...
#### 11.1.2. <a name='OpenVPNtunnelconfiguredwith.ovpnfile'></a>OpenVPN tunnel configured with .ovpn file
...
#### 11.1.3. <a name='WireGuardtunnel'></a>WireGuard tunnel
...
### 11.2. <a name='AWordAboutCloudflares1.1.1.1App'></a>A Word About Cloudflare's 1.1.1.1 App
...
### 11.3. <a name='AWordAboutDNS-over-HTTPS'></a>A Word About DNS-over-HTTPS
...
### 11.4. <a name='AWordAboutHTTP3QUIC'></a>A Word About HTTP/3 (QUIC)
...
### 11.5. <a name='AWordAboutIPv6Routing'></a>A Word About IPv6 Routing
...
### 11.6. <a name='AWordAboutRoutingNetflixAmazonPrimeHuluTraffic'></a>A Word About Routing Netflix/Amazon Prime/Hulu Traffic

There are two following scenarios with VPN connections and Netflix/Amazon Prime/Hulu traffic.

#### 11.6.1. <a name='RoutingNetflixAmazonPrimeHuluTrafficviaVPNTunnel'></a>Routing Netflix/Amazon Prime/Hulu Traffic via VPN Tunnel
...
#### 11.6.2. <a name='RoutingNetflixAmazonPrimeHuluTrafficviaWAN'></a>Routing Netflix/Amazon Prime/Hulu Traffic via WAN
...
### 11.7. <a name='AWordAboutInterfaceHotplugScript'></a>A Word About Interface Hotplug Script
...
### 11.8. <a name='AWordAboutDifferencesfromvpn-policy-routing'></a>A Word About Differences from `vpn-policy-routing`
...
### 11.9. <a name='AWordAboutMigratingfromvpn-policy-routing'></a>A Word About Migrating from `vpn-policy-routing`
...
## 12. <a name='GettingHelp'></a>Getting Help
...
### 12.1. <a name='FirstTroubleshootingStep'></a>First Troubleshooting Step
