...
| Basic          | <a name="dnsmasq_instance"></a>dnsmasq_instance               | string    | `\*`                                                                                                 | String of space-separated DNSMASQ instance numbers (or '\*' for all) to be affected by the service. See [table below](#dns-resolver-option) for additional information.                                                                                                                                                                                                                                        |
