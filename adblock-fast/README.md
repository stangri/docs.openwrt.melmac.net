...
| -              | <a name="procd_lan_interface_name"></a>procd_lan_interface_name | network   | `lan`                                                                                                | The LAN inteface name (if you have changed the name of LAN interface in `/etc/config/network` file from default) to enforce the DNS Hojacking on.                                                                                                                                                                                                                                                              |
